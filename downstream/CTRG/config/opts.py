...
def parse_opt(prefix=None):
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='/home/xuefeng/Chest_New_nitfy_2/',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='/home/xuefeng/label/chest/chest_ctrg_nitfy_ori_split.json',
                        help='the path to the directory containing the data.')
    parser.add_argument('--label_path', type=str, default='/home/xuefeng/CTRG/data_csv/CTRG_finding_labels.csv',
    ...
    parser.add_argument('--dataset_name', type=str, default='ctrg',
                        choices=['iu_xray', 'mimic_cxr', 'covid', 'covidall', 'ctrg'], help='the dataset to be used.')
    ...
    parser.add_argument('-v', '--version', type=str, default="VoCo", help='main model version')
    parser.add_argument('--visual_extractor', type=str, default='swin3d_b',
        choices=['swin3d_b', 'swin3d_l'],
    ...
    parser.add_argument('--d_vf', type=int, default=1152, help='for densenet = 1024, for efficientnet = 1280')
    parser.add_argument('--feature_size', type=int, default=48, help='for swinunetr')
    ...
    parser.add_argument('--num_slices', type=int, default=2, help='the number of slices of the image.')
    ...
    parser.add_argument('--save_dir', type=str, default='/jhcnas5/nixuefeng/jhcpu5_data_files/CTRG/results/', help='the patch to save the models.')
    parser.add_argument('--expe_name', type=str, default='swin3d_nii_scratch', help='extra experiment name')
    ...
    parser.add_argument('--lr_ed', type=float, default=9e-5, help='the learning rate for the remaining parameters.')
...
# 5e-5 1e-4
    ...
    # config
    parser.add_argument('--cfg', type=str, default='/home/xuefeng/CTRG/config/ctrg_swin3d_b.yml',
