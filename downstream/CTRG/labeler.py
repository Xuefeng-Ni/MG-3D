...
chexbert = CheXbert('/home/nixuefeng/Workspace/MRG_baseline/checkpoints/stanford/chexbert/chexbert.pth', 'cpu').to('cpu')

train_data = pd.read_csv('/home/nixuefeng/Workspace/LLM4CTRG/src/Dataset/my_data_csv/CTRG_train.csv')
val_data = pd.read_csv('/home/nixuefeng/Workspace/LLM4CTRG/src/Dataset/my_data_csv/CTRG_val.csv')
test_data = pd.read_csv('/home/nixuefeng/Workspace/LLM4CTRG/src/Dataset/my_data_csv/CTRG_test.csv')
...
gts_chexbert_df.to_csv('/home/nixuefeng/Workspace/CTRG/data_csv/CTRG_finding_labels.csv', index=False)
