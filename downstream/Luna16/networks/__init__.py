...
from networks.swin_b import SwinBTransformer
from networks.swin_l import SwinLTransformer
...
networks_dict= {
    ...
    'swin_b_3d': SwinBTransformer,
    'swin_l_3d': SwinLTransformer
}
...
def get_networks(args):
    ...
    elif network_name == 'swin_b_3d' :
        from monai.utils import ensure_tuple_rep
        spatial_dims = 3
        patch_size = ensure_tuple_rep(2, spatial_dims)
        window_size = ensure_tuple_rep(7, spatial_dims)
        network = networks_dict[network_name](in_chans=args.im_channel,
            embed_dim=48,
