...
class Path(object):
    ...
    def db_root_dir(dataset):
        if dataset == 'luna_ncs':
            ...
            return "/home/xuefeng/LUNA_Classification/MG_split/"
            ...
            return "/jhcnas5/nixuefeng/Chest_New_PCRL_Cubes/"

        elif dataset == 'luna_jigsaw_pretask' or dataset == 'luna_rkb_pretask' or dataset == 'luna_rkbp_pretask':
            return "/jhcnas5/nixuefeng/Chest_New_cropped_x320y320z74/"# "../LUNA2016_processed"
        ...
        elif dataset == 'btcv_seg_train' or dataset == 'btcv_seg_test':
            return '../data/Dataset100_BTCV/BTCV_processed'
