...
class btcv_config:
    attr = 'class'
    object = 'liver'
    train_idx = [n for n in range(0, 20)]
    valid_idx = [n for n in range(20, 25)]
    test_idx = [n for n in range(25, 30)]
    ...
    train_dataset = 'btcv_seg_train'
    eval_dataset = 'btcv_seg_test'
    im_channel = 1
    class_num = 14
    normalization = 'softmax'  # To use bce loss.
