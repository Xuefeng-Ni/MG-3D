...
import sys
sys.path.append('/home/xuefeng/Luna16')
...
##    network = 'unet_3d_rkbp'
    ...
    im_channel = 1
    order_class_num = 100
    k_permutations_path = "/home/xuefeng/Luna16/datasets_3D/Rubik_cube/permutations/permutations_hamming_max_100.npy"
    gaps = [6, 6, 4]
