...
def get_node_classify():
    ...
    for subsetindex in range(10):
        classify_size = 48
        luna_path = "/jhcnas1/jiaxin/data/Luna16-origin/"
        ...
        with open("/jhcnas1/wulinshan/Luna16/pre_processing/candidates.csv")as f:
            f_csv = csv.reader(f)
            i = 0
            for row in f_csv:
                i = i + 1
...
if __name__ == '__main__':
    ...
    get_train_csv(root_dir='/jhcnas1/wulinshan/Data/LUNA_Classification', train_fold=[0, 1, 2, 3, 4],save_path='/jhcnas1/wulinshan/Data/LUNA_Classification/MG_split', aug_range=[0, 10])
    get_test_csv(root_dir='/jhcnas1/wulinshan/Data/LUNA_Classification', test_fold=[5, 6], save_path='/jhcnas1/wulinshan/Data/LUNA_Classification/MG_split', split='valid')
    get_test_csv(root_dir='/jhcnas1/wulinshan/Data/LUNA_Classification', test_fold=[7, 8, 9], save_path='/jhcnas1/wulinshan/Data/LUNA_Classification/MG_split', split='test')
