...
from networks.lib.models.backbones.backbone_selector import BackboneSelector
from networks.lib.models.tools.module_helper import ModuleHelper
...
class CE2P_ASPOCR(nn.Module):
    def __init__(self, configer):
        ...
        from networks.lib.models.modules.edge_block import Edge_Module
        from networks.lib.models.modules.decoder_block import CE2P_Decoder_Module
        ...
        # extra added layers
        from networks.lib.models.modules.spatial_ocr_block import SpatialOCR_ASP_Module
...
class CE2P_OCRNet(nn.Module):
    def __init__(self, configer):
        ...
        from networks.lib.models.modules.edge_block import Edge_Module
        from networks.lib.models.modules.decoder_block import Decoder_Module
        if "wide_resnet38" in self.configer.get('network', 'backbone'):
            in_channels = [2048, 4096] 
            self.edgelayer = Edge_Module(256, 2, bn_type=self.configer.get('network', 'bn_type'), factor=2)
        ...
        # extra added layers
        from networks.lib.models.modules.spatial_ocr_block import SpatialGather_Module, SpatialOCR_Module
