...
from networks.lib.models.modules.projection import ProjectionHead
from networks.lib.utils.tools.logger import Logger as Log
from networks.lib.models.modules.hanet_attention import HANet_Conv
...
class HRNet_W48_OCR_CONTRAST(nn.Module):
    def __init__(self, configer):
        ...
        from networks.lib.models.modules.spatial_ocr_block import SpatialGather_Module
        self.ocr_gather_head = SpatialGather_Module(self.num_classes)
        from networks.lib.models.modules.spatial_ocr_block import SpatialOCR_Module
