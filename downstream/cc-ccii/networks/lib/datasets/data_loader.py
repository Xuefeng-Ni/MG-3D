...
from networks.lib.datasets.loader.default_loader import DefaultLoader, CSDataTestLoader
from networks.lib.datasets.loader.ade20k_loader import ADE20KLoader
from networks.lib.datasets.loader.lip_loader import LipLoader
from networks.lib.datasets.loader.offset_loader import DTOffsetLoader
from networks.lib.datasets.tools.collate import collate
from networks.lib.utils.tools.logger import Logger as Log

from networks.lib.utils.distributed import get_world_size, get_rank, is_distributed
...
class DataLoader(object):
    ...
    def __init__(self, configer):
        ...
        from networks.lib.datasets.tools import cv2_aug_transforms
    ...
    def get_dataloader_sampler(self, klass, split, dataset):
        ...
        from networks.lib.datasets.loader.multi_dataset_loader import MultiDatasetLoader, MultiDatasetTrainingSampler
