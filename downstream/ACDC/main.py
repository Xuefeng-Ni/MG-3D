...
parser.add_argument("--name", default='SwinB', help="the name of pre-trained model !!!!!!!!")
...
parser.add_argument("--data_dir", default="/mnt/hdd2/xuefeng/Dataset027_ACDC", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/mnt/hdd2/xuefeng/cache/ACDC/", type=str, help="dataset directory")

parser.add_argument("--json_list", default="/home/xuefeng/Large-Scale-Medical/Downstream/monai/ACDC/ACDC_fold0.json", type=str, help="dataset json file")
