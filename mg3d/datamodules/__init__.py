...
from .pretraining_chest_ctrg_datamodule import CHESTCTRGDataModule
from .clm_chest_ctrg_datamodule import CLMCHESTCTRGDataModule
...
_datamodules = {
    ...
    "chest_ctrg": CHESTCTRGDataModule,
    "clm_chest_ctrg": CLMCHESTCTRGDataModule
}
